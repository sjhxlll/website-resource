//一定要修改音效为本地路径，为方便演示，已经把路径做了替换，改正只需要将https://www.noisework.cn/改为https://www.noisework.cn/ 就是本地的路径

document.addEventListener('DOMContentLoaded', function() {
    // 预加载音效
    var leftClickSound = new Audio('https://www.noisework.cn/assets/sound/鼠点左2.mp3'); // 鼠标左
    var rightClickSound = new Audio('https://www.noisework.cn/assets/sound/风铃.mp3'); // 鼠标右
    var hoverSoundlogoDiv = new Audio('https://www.noisework.cn/assets/sound/门铃.mp3'); // 头像logo
    var hoverSoundavatar = new Audio('https://www.noisework.cn/assets/sound/门铃.mp3'); // 头像logo
    var hoverSoundfirst = new Audio('https://www.noisework.cn/assets/sound/开瓶.mp3'); // 首页切换风格文字
    var hoverSoundclock = new Audio('https://www.noisework.cn/assets/sound/叮.mp3'); // 时钟
    var hoverSounddescriptiontext1 = new Audio('https://www.noisework.cn/assets/sound/开瓶.mp3'); // home切换模式文字
    var hoverSounddescriptiontext3 = new Audio('https://www.noisework.cn/assets/sound/滴滴.mp3'); // home运行文字
    var hoverSoundcheck1 = new Audio('https://www.noisework.cn/assets/sound/开瓶.mp3'); // 首页右侧切换模式文字
    var hoverSoundtypingText = new Audio('https://www.noisework.cn/assets/sound/打字.mp3'); // home页打字机文字
...
// 元素音效
// 网址过渡音
var websiteHoverSound = new Audio('https://www.noisework.cn/assets/sound/缓慢1.mp3');
websiteHoverSound.preload = 'auto';

// 广告位音
var adHoverSound = new Audio('https://www.noisework.cn/assets/sound/滴滴.mp3');
...
// home配置文档文字音
var hoverSoundescriptiontext2 = new Audio('https://www.noisework.cn/assets/sound/滴滴.mp3'); // 请替换为您的音效文件路径
...
// 配置音乐菜单选择音效
var hoverSoundPath = 'https://www.noisework.cn/assets/sound/缓慢1.mp3';
...
// 浮动文字
var floatingTextSoundPath = 'https://www.noisework.cn/assets/sound/jump.mp3';
...
// 页面加载音效
soundFiles = [
    'https://www.noisework.cn/assets/sound/载入1.mp3',
    'https://www.noisework.cn/assets/sound/载入2.mp3',
    'https://www.noisework.cn/assets/sound/载入3.mp3',
    'https://www.noisework.cn/assets/sound/载入4.mp3',
    'https://www.noisework.cn/assets/sound/载入5.mp3',
    'https://www.noisework.cn/assets/sound/载入6.mp3',
    'https://www.noisework.cn/assets/sound/载入7.mp3',
    'https://www.noisework.cn/assets/sound/载入8.mp3',
    'https://www.noisework.cn/assets/sound/载入9.mp3',

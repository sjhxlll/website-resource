(function() {
	var Engine = window.Engine = {
		SITE_URL: encodeURIComponent("https://www.4p4.cn/adarkroom"),
		VERSION: 1.3,
		...
		init: function(options) {
			...
			$('<span>')
				.addClass('menuBtn')
				.text(_('官网'))
				.click(function() { window.open('https://www.4p4.cn'); })
				.appendTo(menu);
					...
					start: {
						...
						buttons: {
							'facebook': {
								...
								nextScene: 'end',
								onChoose: function() {
									window.open('https://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=' + Engine.SITE_URL, 'sharer', 'width=626,height=436,location=no,menubar=no,resizable=no,scrollbars=no,status=no,toolbar=no');
								}
							},
							'google': {
								text:_('google+'),
